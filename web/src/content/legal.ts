...
export const privacySections = [
  ...
  },
  {
    ...
    body: [
      ...
      "Optional website analytics: If you allow analytics, Backword uses Google Firebase Analytics to measure page views, broad campaign source, game and Pro-subscription milestones, sign-in milestones, App Store link clicks, grouped content-load failures, and result-card share interactions and outcomes. We do not send guesses, answers, clue text, entered letters, account identifiers, names, email addresses, Stripe customer details, checkout identifiers, or payment information to website analytics."
    ]
  },
  {
