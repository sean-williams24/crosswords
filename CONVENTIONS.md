...
The clue explainer banner is shown only while the player has made no guesses. After one minute in the game with no guess, its short prompt changes to clarify that the clue may be an associated word or another connection to the answer. Making the first guess hides the banner and cancels its countdown.
